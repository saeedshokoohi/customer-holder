...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .get("/services/customerholder/api/customers")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new customer")
            .post("/services/customerholder/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "title":"SAMPLE_TEXT"
                ...
                , "paymentConfig":"SAMPLE_TEXT"
                , "notificationConfig":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/services/customerholder${new_customer_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created customer")
            .delete("/services/customerholder${new_customer_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
