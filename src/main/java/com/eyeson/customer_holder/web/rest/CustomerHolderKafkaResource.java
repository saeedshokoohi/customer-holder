...
@RestController
@RequestMapping("/api/customer-holder-kafka")
public class CustomerHolderKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CustomerHolderKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CustomerHolderKafkaResource(KafkaProperties kafkaProperties) {
